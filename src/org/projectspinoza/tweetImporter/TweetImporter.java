 ...
 * @author Muhammad
 */
public class TweetImporter implements FileImporter, LongTask {
        ...
        while (reader.ready()) {
            ...
            if (sv != null) {
                ...
                if (svp.length > 1) {
                    ...
                    for (String sp : svp) {
                        if (line.contains(sp)) {sv_found = true;}
                    }
    ...
    private void addToContainer(List<String[]> edges) {
        for (String[] edge : edges) {
            ...
            edgeDraft.setType(EdgeDraft.EdgeType.DIRECTED);
    ...
    /**
     * creates or returns nodeDraft with the id
     * 
     * @param id
     * @param label
     * @return NodeDraft
